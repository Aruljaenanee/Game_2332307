(function () {
  ...
  N2D("NextgenmediaSVGPlugin", ["GSAP"], function (t, e) {
    var r = this;
      ...
      var t = Math.PI / 180,
        ...
        c = function (r, n, o, i, a, s, l, h, c) {
          if (r !== h || n !== c) {
            ...
            (B = Math.sqrt((Y * Y + q * q) * (C * C + R * R))),
              (V = Y * C + q * R),
              (z = 0 > Y * R - q * C ? -1 : 1);
            var D = z * Math.acos(V / B) * e;
            !l && D > 0 ? (D -= 360) : l && 0 > D && (D += 360),
              (D %= 360),
              (X %= 360);
            var F,
              j,
        ...
        f = function (t) {
          ...
          if (!t || !isNaN(b[0]) || isNaN(b[1]))
            return h("ERROR: malformed path data: " + t), A;
          for (e = 0; y > e; e++)
            if (
              ((M = a),
              isNaN(b[e]) ? ((a = b[e].toUpperCase()), (l = a !== b[e])) : e--,
              (o = +b[e + 1]),
              (i = +b[e + 2]),
              l && ((o += m), (i += N)),
              0 === e && ((f = o), (g = i)),
              ...
              "Z" === a && ((o = f), (i = g), (u.closed = !0)),
                ("L" === a || Math.abs(m - o) > 0.5 || Math.abs(N - i) > 0.5) &&
                  ((u[x++] = m + (o - m) / 3),
                  (u[x++] = N + (i - N) / 3),
                  (u[x++] = m + (2 * (o - m)) / 3),
                  (u[x++] = N + (2 * (i - N)) / 3),
        ...
        d = function (t) {
          for (var e = [], r = t.length - 1, n = 0; --r > -1; )
            (e[n++] = t[r]), (e[n++] = t[r + 1]), r--;
        ...
        b = function (t) {
          for (
            ...
            for (i = t[a], e = i.length, o = 6; e > o; o += 6)
              (r = i[o]),
                (n = i[o + 1]),
                r > s ? (s = r) : l > r && (l = r),
                n > h ? (h = n) : u > n && (u = n);
        ...
        x = function (t, e, r) {
          var n,
            ...
            f = 0;
          for (i = 6; a > i; i += 6)
            (o = y(t, e, i / 6, h, u)), c > o && ((c = o), (f = i));
          if (r)
            for (n = t.slice(0), d(n), i = 6; a > i; i += 6)
              (o = y(n, e, i / 6, h, u)), c > o && ((c = o), (f = -i));
          return f / 6;
        },
        z = function (t, e, r) {
          for (
            var n, o, i, a, s, l, h = t.length, u = 99999999999, c = 0, f = 0;
            --h > -1;

          )
            for (n = t[h], l = n.length, s = 0; l > s; s += 6)
              (o = n[s] - e),
                (i = n[s + 1] - r),
                (a = Math.sqrt(o * o + i * i)),
                u > a && ((u = a), (c = n[s]), (f = n[s + 1]));
          return [c, f];
        },
        P = function (t, e, r, n, o, i) {
          var a,
            ...
            d = t.centerX + o,
            v = t.centerY + i;
          for (s = r; c > s && ((a = e[s].size || M(e[s])), !(g > a)); s++)
            (l = e[s].centerX - d),
              (h = e[s].centerY - v),
              (u = Math.sqrt(l * l + h * h)),
              p > u && ((f = s), (p = u));
        ...
        S = function (t, e, r, n) {
          ...
          if (v[0]) {
            if (
              ...
              (u = p.size || b(p)),
              (u = v.size || b(v)),
              (u = p.centerX - v.centerX),
              (c = p.centerY - v.centerY),
              S === m)
            )
              for (w = 0; w < v.length; w++)
                p.splice(w, 0, P(v[w], p, w, _, u, c));
            if (f)
              for (
                0 > f && (f = -f),
                  p[0].length > v[0].length &&
                    g(v[0], ((p[0].length - v[0].length) / 6) | 0),
                  w = v.length;
                f > y;

              )
                (s = p[w].size || M(p[w])),
                  (a = z(v, p[w].centerX, p[w].centerY)),
                  (s = a[0]),
                  (l = a[1]),
                  (v[w++] = [s, l, s, l, s, l, s, l]),
                  (v.totalPoints += 8),
            ...
            for (w = 0; w < t.length; w++)
              (o = e[w]),
                (i = t[w]),
                (f = o.length - i.length),
                0 > f ? g(o, (-f / 6) | 0) : f > 0 && g(i, (f / 6) | 0),
                G && !i.reversed && d(i),
                (r = T[w] || 0 === T[w] ? T[w] : "auto"),
                r &&
                  (i.closed ||
        ...
        _ = function (t, e, r, n) {
          var o = f(t[0]),
            i = f(t[1]);
          S(o, i, e || 0 === e ? e : "auto", r) &&
            ((t[0] = p(o)),
            (t[1] = p(i)),
            ("log" === n || n === !0) &&
              h('precompile:["' + t[0] + '","' + t[1] + '"]'));
        },
        w = function (t, e, r) {
          return e || r || t || 0 === t
            ? function (n) {
        ...
        T = function (t, e) {
          ...
          for (
            "reverse" === e
              ? ((n = s - 1), (r = -2))
              : ((n = (2 * (parseInt(e, 10) || 0) + 1 + 100 * s) % s), (r = 2)),
              i = 0;
            s > i;
            i += 2
          )
        ...
        G = function (t, e) {
          var r,
            ...
            g = 0.999999;
          for (
            o = t.length, r = (0.5 * e) / (0.5 * o - 1), n = 0;
            o - 2 > n;
            n += 2
          ) {
            if (
              ...
              for (a = 1 / (Math.floor(h) + 1), i = 1; h > g; )
                (f +=
                  (u + (s - u) * a * i).toFixed(2) +
                  "," +
                  (c + (l - c) * a * i).toFixed(2) +
        ...
        Y = function (t, e) {
          var n,
            ...
            a = i.length;
          for (e = "," + e + ","; --a > -1; )
            (n = i[a].nodeName.toLowerCase()),
              -1 === e.indexOf("," + n + ",") &&
                o.setAttributeNS(null, n, i[a].nodeValue);
          return o;
        },
        q = function (t, e) {
          var r,
            ...
            y,
            x,
            z = t.tagName.toLowerCase(),
            P = 0.552284749831;
          return "path" !== z && t.getBBox
            ? ((l = Y(t, "x,y,width,height,cx,cy,rx,ry,r,x1,x2,y1,y2,points")),
              "rect" === z
                ? ((a = +t.getAttribute("rx") || 0),
                  (s = +t.getAttribute("ry") || 0),
                  (n = +t.getAttribute("x") || 0),
                  (i = +t.getAttribute("y") || 0),
                  (f = (+t.getAttribute("width") || 0) - 2 * a),
                  (g = (+t.getAttribute("height") || 0) - 2 * s),
                  a || s
                    ? ((p = n + a * (1 - P)),
                      (d = n + a),
                      (v = d + f),
                ...
                : "circle" === z || "ellipse" === z
                ? ("circle" === z
                    ? ((a = s = +t.getAttribute("r") || 0), (u = a * P))
                    : ((a = +t.getAttribute("rx") || 0),
                      (s = +t.getAttribute("ry") || 0),
                      (u = s * P)),
                  (n = +t.getAttribute("cx") || 0),
                  (i = +t.getAttribute("cy") || 0),
                  (h = a * P),
                  (r =
                    "M" +
                    (n + a) +
                ...
                : ("polyline" === z || "polygon" === z) &&
                  ((c = (t.getAttribute("points") + "").match(o) || []),
                  (n = c.shift()),
                  (i = c.shift()),
                  (r = "M" + n + "," + i + " L" + c.join(",")),
                  "polygon" === z && (r += "," + n + "," + i + "z")),
        ...
        C = function (t, e, r) {
          var n,
            ...
            s = "string" == typeof t;
          return (
            (!s || i.test(t) || (t.match(o) || []).length < 3) &&
              ((n = s ? l.selector(t) : t && t[0] ? t : [t]),
              n && n[0]
                ? ((n = n[0]),
                  (a = n.nodeName.toUpperCase()),
                  e && "PATH" !== a && ((n = q(n, !1)), (a = "PATH")),
                  (t = n.getAttribute("PATH" === a ? "d" : "points") || ""),
                  n === r && (t = n.getAttributeNS(null, "data-original") || t))
                : (h("WARNING: invalid morph to: " + t), (t = !1))),
            t
          );
        },
        R =
          "Use NextgenmediaSVGPlugin.convertToPath(elementOrSelectorText) to convert to a path before morphing.",
        B = r._gsDefine.plugin({
          ...
          init: function (t, e, r, n) {
            var o, i, s, l, u;
            return "function" != typeof t.setAttribute
              ? !1
              : ("function" == typeof e && (e = e(n, t)),
                ...
                "PATH" === o || u
                  ? ((i = "PATH" === o ? "d" : "points"),
                    ...
                    (l = C(e.shape || e.d || e.points || "", "d" === i, t)),
                    u && a.test(l)
                      ? (h(
                          "WARNING: a <" + o + "> cannot accept path data. " + R
                        ),
                        !1)
                      : (l &&
                          ((this._target = t),
                          ...
                          s &&
                            ...
                            (s.endProp = i))),
                        !0))
                  : (h("WARNING: cannot morph a <" + o + "> SVG element. " + R),
                    !1));
          },
          set: function (t) {
            var e;
            if ((this._super.setRatio.call(this, t), 1 === t))
              for (e = this._firstPT; e; )
                e.end && this._target.setAttribute(e.endProp, e.end),
                  (e = e._next);
          },
        });
      (B.pathFilter = _),
        (B.pointsFilter = I),
        (B.subdivideRawBezier = g),
        (B.defaultMap = "size"),
        (B.pathDataToRawBezier = function (t) {
          return f(C(t, !0));
        }),
        (B.equalizeSegmentQuantity = S),
        (B.convertToPath = function (t, e) {
          ...
          if (
            ...
            "relative" === u || u === !0
              ...
              : ((a += i[4]),
                ...
                u &&
                  ((u =
                    "string" == typeof u ? l.selector(u) : u && u[0] ? u : [u]),
                  u &&
                    u[0] &&
                    ((h = u[0].getBBox() || {
                      x: 0,
